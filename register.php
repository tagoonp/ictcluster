...
<html lang="en" dir="ltr">
  ...
  <div style="margin-top: 60px;">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <h1 class="text-center">สมัครใช้งาน</h1>
            ...
            <div class="row mt-3">
              <div class="col-12">
                <div class="form-group">
                  <input type="text" class="form-control" name="txtFname" id="txtFname" placeholder="ชื่อ ...">
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
                  <input type="text" class="form-control" name="txtLname" id="txtLname" placeholder="นามสกุล ...">
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
                  <input type="text" class="form-control" name="txtPhone" id="txtPhone" placeholder="หมายเลขโทรศัพท์ที่ติดต่อได้ ...">
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
              ...
              <div class="col-12">
                <div class="form-group">
                  <input type="password" class="form-control" name="txtPassword1" id="txtPassword1" placeholder="ตั้งรหัสผ่านสำหรับเข้าใช้งานระบบนี้ ...">
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
                  <input type="password" class="form-control" name="txtPassword2" id="txtPassword2" placeholder="ใส่รหัสผ่านอีกครั้ง ...">
                </div>
              </div>
              <div class="col-12">
                <div class="form-group text-center">
                  <button type="submit" name="button" class="btn btn-primary btn-block">ลงทะเบียน</button>
                </div>
              </div>
              <div class="col-12">
                <div class="form-group text-center">
                  <button type="button" name="button" class="btn btn-block" onclick="window.location='login'">- กลับหน้าเข้าสู่ระบบ -</button>
                </div>
              </div>
            </div>
          </form>
  ...
  <script type="text/javascript" src="./assets/custom/js/page/register.js"></script>
